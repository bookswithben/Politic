...
@interface UnitOneViewController ()

@end

@implementation UnitOneViewController
...
- (void) addConstraints {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(marker5, marker10, marker25, markerRand, unit1, politics, close);
    
    NSDictionary *metrics = @{@"widthFromTop":@50.0,@"widthFromSides":@50.0, @"heightFromTextElement":@15.0, @"heightFromFirstlabelElement":@100.0, @"heightButton":@60.0, @"HeightLabelToLabel":@25.0, @"closeButton":@25, @"closeButtonVertical":@30};
...
- (void) questionModal:(UIButton *)sender {
    ...
    modalViewController.unitChoice = 1;
